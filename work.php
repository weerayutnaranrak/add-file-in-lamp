        ...
        <div class="card mt-5">
            <form action="save.php" method="post">
                ...
                <div class="col-4 offset-6">
                    Total :<input type="text" name="alltotal1" class="form-control" id="alltotal1" value="0" readonly>
                </div>
                <table id="appengrid2" class="mt-5"></table>
                <div class="col-4 offset-6">
                    Total :<input type="text" name="alltotal2" class="form-control" id="alltotal2" value="0" readonly>
                </div>
                <input type="hidden" name="grid1" id="grid1">
                <input type="hidden" name="grid2" id="grid2">
                <div class="text-center mt-2">
                    <button onclick="submit1();" name="submit" class="btn btn-success">SAVE</button>
                    <button type="reset" class="btn btn-danger">RESET</button>
                    
                </div>
            </form>
            
            <!-- <button onclick="submit()">sdsdfd</button> -->
        </div>
